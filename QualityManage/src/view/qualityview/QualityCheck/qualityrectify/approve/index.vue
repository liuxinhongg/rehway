<template>
  <div>
    <el-form :model="sousou" class="searchfrom" :inline="true" @submit.native.prevent>
           <el-form-item prop="chkMan" label="整改审核人：">
                <el-select v-model="sousou.chkMan" style="width:280px">
                    <el-option v-for="(item,index) in personoption" :key="index" :value="item.workerId" :label="item.workerName"> 
                    </el-option>
                </el-select>
            </el-form-item>
      <el-form-item prop="state" label="审核状态：" style="margin-left:20px;">
    ...
    <el-table ref="multipleTable" :data="hiddenpageData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
        ...
        <el-table-column label="操作" width="90" fixed="right">
          <template slot-scope="scope">
            <el-button type="text" @click="verifier(scope.row.id)">审批</el-button>
          </template>
        </el-table-column>
      </el-table>
    <div class="block">
