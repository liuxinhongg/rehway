                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="chkRectify">
                                <el-input v-model="projcheckform.chkRectify" style="width:280px"></el-input>                                
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="chkArea">
                                <el-input v-model="projcheckform.chkArea" style="width:280px"></el-input>                                                                
                            </el-form-item>
                        </td>
                         <td class="tdleft">检查频率：</td>
                        <td>
                            <el-form-item prop="freq">
                                <el-input v-model="projcheckform.freq" style="width:280px"></el-input>                                
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="rectifyMode">
                                <el-input v-model="projcheckform.rectifyMode" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="descri">
                                <el-input v-model="projcheckform.descri" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="chkReal">
                                <el-input v-model="projcheckform.chkReal" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
...
export default {
    data(){
        ...
        return{
            ...
            hiddenpageData:[],
            useryz:{
                planId:[{required: true,message: "检查计划",trigger: "change"}],
                chkDate:[{required: true,message: "检查时间",trigger: "change"}],
                chkMan:[{required: true,message: "实际检查人",trigger: "change"}],
                ...
                chkReal:[{required: true,message: "检查真实情况内容",trigger: "blur"}],
                chkArea:[{required: true,message: "检查部位",trigger: "blur"}],
                descri:[{required: true,message: "检查内容",trigger: "blur"}],
                freq:[{required: true,message: "检查频率",trigger: "blur",type:'number'}],
                proId:[{required: true,message: "id",trigger: "blur"}],
