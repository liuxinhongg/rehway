<template>
  <div>
    <el-form :model="sousou" class="searchfrom" :inline="true" @submit.native.prevent>
      <el-form-item label="整改位置：" prop="loc">
          <el-input v-model="sousou.loc" ></el-input>
      </el-form-item>
      <el-form-item label="实际检查人：" prop="chkMan" style="margin-left:30px;">
   ...
   <el-table ref="multipleTable" :data="hiddenpageData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
        ...
        <el-table-column label="整改审核人" prop="dirManName" width="120"></el-table-column>
