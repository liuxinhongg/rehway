...
<template>
  <div>
    <el-form :inline="true" :model="newsform" class="searchTop" @submit.native.prevent>
      ...
      <el-form-item>
        <span>发布者：</span> 
        <el-input placeholder="请输入发布者" v-model="newsform.title" style="width:200px;"></el-input>
      </el-form-item>
      <el-form-item>
        <span>发布时间：</span>
    ...
    <el-table :data="adverData" border style="width: 90%;margin:0 auto;">
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button type="danger" size="mini"  @click="deletehanle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="block">
