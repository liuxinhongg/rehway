            ...
            <div v-if="nextnumber == 1" >
                <table border="1" class="tableinsert">
                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item label="" prop="cultureLevelType" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item label='' required v-if="isselect==true">
                                <el-date-picker
                                style="width:280px"
                                type="date"
                                placeholder="选择日期"
        ...
        this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    if(this.form.isJoined == 1){
                        ...
                        formbut.append('joinedTime',this.form.joinedTime.getTime()) ,
                ...
                this.$http.post('/api/user/user_insert_info',formbut).then(res=>{
                    console.log(res);
