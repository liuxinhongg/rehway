        ...
        <div class="alltable">
            <el-scrollbar style="height:100%;">
                <el-table :data="trainData" border  style="width: 100%">
                    <!-- 项目名称 -->
                    <el-table-column label="工程名称" width="180">
                    ...
                    <el-table-column label="分包单位名称" prop="subCorpName" width="180"></el-table-column>
                    <el-table-column prop="subCorpCode" label="分包单位统一信用码" >
                        <template slot-scope="scope">
                            <el-tooltip trigger="hover" placement="top">
                                <div slot="content">{{ scope.row.subCorpCode }}</div>
                                <div class="boxInput">{{ scope.row.subCorpCode }}</div>
                            </el-tooltip>
                        </template>
                    </el-table-column>
                    <el-table-column label="施工许可证编码" prop="builderLicenses" width="180"></el-table-column>
                    <el-table-column prop="categoryTypeName" label="项目分类" width="180"></el-table-column>
                    <el-table-column prop="address" label="项目所在地"></el-table-column>
                    <el-table-column prop="stateType" label="项目状态" width="120"> </el-table-column>
