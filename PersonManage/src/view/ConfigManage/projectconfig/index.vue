    ...
    <div class="teamconfig">
        ...
        <el-form :inline="true" :model="projectform" class="demo-form-inline" @submit.native.prevent>
            <el-form-item label="项目编码：">
                <el-input v-model="projectform.projectCode" placeholder="项目编码"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" native-type="submit"  @click="search" icon="el-icon-search">搜索</el-button>
            </el-form-item>
            <el-form-item style="float:right">
                <el-button @click="addtrain">+新增项目</el-button>
            </el-form-item>
        </el-form>
        <!-- 列表显示信息 -->
        <div class="alltable">
            <el-scrollbar style="height:100%;">
                <el-table :data="trainData" border  style="width: 100%">
                    ...
                    <el-table-column label="项目编码" prop="projectCode" width="180">45454</el-table-column>
                    <el-table-column prop="contractorCorpName" label="总承包单位名称" >
                        <template slot-scope="scope">
                            <el-tooltip trigger="hover" placement="top">
...
export default {
    ...
    methods:{
        ...
        // 编辑
        handleClick(id){
            this.$router.push({path:'/project/projectadd?id='+id});
        },
        // 删除
        deleteClick(id){
            console.log(id);
