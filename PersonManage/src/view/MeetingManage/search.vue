  ...
  <div class="meetinglist">
    ...
    <el-scrollbar style="height:100%;">
      ...
      <el-table :data="tableData" border style="width: 90%;margin:0 auto" >
        <el-table-column type="index" label="编号" width="100" fixed></el-table-column>
        ...
        <el-table-column label="会议文件">
          <template slot-scope="scope">
            <el-tooltip trigger="hover" placement="top">
              ...
              <div class="boxInput">
                <a :href="'/api/took/user_get_photo?fileName='+scope.row.file">{{scope.row.fileName }}</a>              
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        <el-table-column label="操作" fixed="right" width="100" style="background:#fff;">
          <template slot-scope="scope">
