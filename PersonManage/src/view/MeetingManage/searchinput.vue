        ...
        <tr>
            ...
            <td> 
              <el-form-item prop="compere">
                <el-input v-model="addmeetform.compere" placeholder="主讲人"></el-input>
              </el-form-item>
            </td>
            <td class="tdleft">参会人数：</td>
            <td>
              <el-form-item prop="number">
                <el-input v-model="addmeetform.number" placeholder="参会人数" type="number"></el-input>
              </el-form-item>
            </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"> 
            <el-form-item prop="title">
              <el-input v-model="addmeetform.title" type="textarea" :rows="2"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="3"> 
            <el-form-item prop="address">
              <el-input v-model="addmeetform.address" type="textarea" :rows="2"></el-input>
            </el-form-item>
          </td>
        </tr>
      </table>
