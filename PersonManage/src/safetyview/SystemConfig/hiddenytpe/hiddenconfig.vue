...
<template>
    <div class="hiddenconfig">
        <el-form :model="integral" style="margin:auto;width:95%;"  :inline="true" label-width="120px;" @submit.native.prevent>
            ...
            <el-form-item style="float:right;">
                <el-button @click="addhiddenconfig">+ 新建</el-button>
            </el-form-item>
        </el-form>
            ...
            <el-form :model="hiddenform" ref="hiddenform">
                <table border="1" class="tableinsert" style="width:60%;">
                    <tr>
                        ...
                        <td colspan="2">
                            <el-form-item prop="riskType" :rules="[{ required: true, message: '请输入区域名称', trigger: 'blur' }]">
                                <el-input v-model="hiddenform.riskType" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
    ...
    methods:{
        ...
        submitForm(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$http.post('/api/risk_type/insert',subhiddenform).then(res=>{
                        console.log(res);
        ...
        deletehandle(id){
            this.$confirm('此操作将永久删除该条数据, 是否继续?', '提示', {
                ...
                this.$http.post('/api/risk_type/delete?code='+id).then(res=>{
                    console.log(res);
                    if(res.data.result='success'){
                        this.$message({
                            type: 'success',
        ...
        localdata(){
            ...
            this.$http.get('/api/dict/rist_type',{params:data}).then(res=>{
                console.log(res);
