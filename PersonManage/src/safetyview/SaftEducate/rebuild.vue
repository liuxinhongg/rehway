                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="title">
                                <el-input v-model="saftform.title" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="worktype">
                                <el-select v-model="saftform.worktype" style="width:280px">
                                    <el-option v-for="(item,index) in worktypeoption" :key="index" :value="item.workertype" :label="item.worker"></el-option>
                                </el-select>
                            </el-form-item>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="remark">
                                <el-input v-model="saftform.remark" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    if(this.eduId==0){
                        ...
                        this.$http.post('/api/risk_edu/insert',eduform,{ headers: { 'Content-Type': 'application/x-www-form-urlencoded' }}).then(res=>{
                            console.log(res);
