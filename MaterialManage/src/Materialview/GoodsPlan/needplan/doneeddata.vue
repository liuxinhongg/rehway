        ...
        <div v-if="childsta==false">
            <el-scrollbar style="height:100%;overflow-x: hidden;">    
                <el-form :model="saftplanform" :rules="useryz" @submit.native.prevent  ref="saftplanform">
                    <el-form-item class="persontop"><h3>材料需用计划表</h3></el-form-item>
                    <table border="1" class="tableinsert">
                        <tr>
                            <td class="tdleft" colspan="1">需求计划名称：</td>
                            <td colspan="9">
                                <el-form-item prop="mrName">
                                    <el-input  :disabled="true"  v-model="saftplanform.mrName" style="width:280px" placeholder="总计划名称"></el-input>
                                </el-form-item>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="9">
                                <el-form-item prop="cmtMan">
                                    <el-select  :disabled="true"  v-model="saftplanform.cmtMan" style="width:280px">
                            ...
                            <td  colspan="9">
                                <el-form-item prop="execMan">
                                    <el-select  :disabled="true"  v-model="saftplanform.execMan"  style="width:280px">
                                        <el-option v-for="(item,index) in personoption" :key="index" :value="item.workerId" :label="item.workerName"> 
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                        ...
                        <tr>
                            ...
                            <td colspan="9">
                                <el-form-item prop="cmtDate">
                                    <el-date-picker :disabled="true" v-model="saftplanform.cmtDate" type="datetime" placeholder="选择日期时间" style="width:280px"></el-date-picker>
                                </el-form-item>
                            </td> 
                            <td class="tdleft">到场日期：</td>
                            <td  colspan="9">
                                <el-form-item prop="comeDate">
                                    <el-date-picker  :disabled="true"   v-model="saftplanform.comeDate" type="datetime" placeholder="选择日期时间" style="width:280px"></el-date-picker>
                                </el-form-item>
                            </td> 
                        </tr>
                        <!-- <tr>
                            ...
                            <td  colspan="19">
                                ...
                                <el-select v-model="saftplanform.state" :disabled="true">
                                    <el-option value="0" label="未审批"></el-option>
                                    <el-option value="1" label="审批中"></el-option>
                                    <el-option value="2" label="未审同意"></el-option>
                                    <el-option value="3" label="审批未通过"></el-option>
                                </el-select>
                                </el-form-item>
                            </td> 
                        </tr> -->
                        <tr>
                            <td colspan="20">
                            <span style="margin:0 40%;font-size:18px;font-family: '楷体';">物资需求明细</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="provDateTime">
                                    <el-date-picker  v-model="modelform.provDateTime" type="datetime" placeholder="选择日期时间" style="width:280px"></el-date-picker>
                                </el-form-item>
                            </td> 
                        </tr>
                        <tr>
...
export default {
    ...
    data(){
        return{
            ...
            childsta:false,
            modelrules:{
                mnum:[{min:'1',max:'2147483647', required: true,message: "请输入需用使用量",trigger: "blur",}],
                ...
                provDateTime:[{required: true,message: "请选择供应商确认时间",trigger: "change"}],
            },
            modeloption:[],
            materoption:[],
            localoption:[],
            ...
            useryz:{
                ...
                mrName:[{required: true,message: "请输入总计划名称",trigger: "blur"}],
            },
            saftplanId:0,
            modleId:0,
            childValue:[],
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    if(this.saftplanId==0){
                        ...
                        this.$http.post(material.mrequireinsert,this.ajform).then(res=>{
                        ...
                        // 编辑的方法
                        this.ajform.append('mrid',this.saftplanId)
                        if(typeof(this.saftplanform.comeDate)=='number'){
                            this.ajform.append('comeDateTime',this.saftplanform.comeDate)
                        }else{
                            this.ajform.append('comeDateTime',this.saftplanform.comeDate.getTime())
                        }
                        this.$http.post(material.mrequiredataupdate,this.ajform).then(res=>{
                            if(res.data.result=='success'){
        ...
        modelesubmit(Fname){
            if(this.id==0){
                    if(this.modId==0){
                        ...
                        // console.log(this.modelform.provDate);
                        this.modelform.provDateTime=this.modelform.provDate.getTime()
                        ...
                        if(this.doubledata.length!=0){
                            for(let item in this.doubledata,this.materoption,this.localoption){
                                if(this.materoption[item].id==this.modelform.mmid){
                                    ...
                                    // this.modelform.uselocName= this.localoption[item].useloc;
                                }
                    ...
                    Fname.mrid = this.id
                    console.log(Fname);
                    // Fname.provDateTime = Fname.provDate
                    // console.log(typeof(Fname.provDateTime),Fname.provDateTime)
                    if(typeof(Fname.provDateTime)!='number'){
                        Fname.provDateTime=Fname.provDateTime.getTime();
                    }
                    console.log(Fname)
                    this.$http.get(material.mrequireupdate,{params:Fname}).then(res=>{
                        console.log(res);
