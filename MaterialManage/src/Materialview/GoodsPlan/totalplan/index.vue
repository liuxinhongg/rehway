  ...
  <div>
    ...
    <el-table ref="multipleTable" :data="adverData" tooltip-effect="dark" border style="width: 90%;margin:auto;" >
      ...
      <!-- <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button type="text"  @click="modify(scope.row.planid)" ><i class="iconfont icon-edit"></i> 编辑</el-button>
          <el-button type="text" @click="modifydata(scope.row.planid)" icon="el-icon-info">详情</el-button>
        </template>
      </el-table-column> -->
    </el-table>
    <div class="block">
