                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="reponame">
                                <el-input v-model="storehouseform.reponame" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                        <td class="tdleft">仓库位置：</td>
                        <td>
                           <el-form-item prop="repoloc">
                                <el-input v-model="storehouseform.repoloc" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
...
export default {
    data(){
        return{
            ...
            useryz:{          
                reponame:[{required: true,message: "请输入供应商名称",trigger: "blur"}],
                repoloc:[{required: true,message: "请输入供应商地址",trigger: "blur"}],
                reman:[{required: true,message: "请输入供应商负责人",trigger: "blur"}],
            },
            storeId:0,
        }
    },
