<template>
  <div>
    ...
    <el-form :model="mrepoform" class="searchfrom" :inline="true" @submit.native.prevent>
      <el-form-item>
        <span>合同名称：</span><el-input v-model="mrepoform.reponame" style="width:200px;" placeholder="请输入合同名称"></el-input>
      </el-form-item>
      <el-form-item>
        <span>合同管理员：</span>
    ...
    <el-table ref="multipleTable" :data="packData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
      ...
      <el-table-column label="合同编号" prop="repoid" width="150"></el-table-column>  
      <el-table-column label="合同管理员" prop="remanName" width="200"></el-table-column>
