<template>
    <div class="supplymaterial">
        ...
        <el-scrollbar style="height:100%;">    
                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="pname">
                                <el-input v-model="applayform.pname" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="paddr">
                                <el-input v-model="applayform.paddr" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="leader">
                                <el-input v-model="applayform.leader" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                        <td class="tdleft">负责人身份证号码：</td>
                        <td>
                           <el-form-item prop="personid">
                                <el-input v-model="applayform.personid" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="telno">
                                <el-input v-model="applayform.telno" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                        <td class="tdleft">社会信用号：</td>
                        <td>
                           <el-form-item prop="coid">
                                <el-input v-model="applayform.coid" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="bankcode">
                                <el-input v-model="applayform.bankcode" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item >
                                <el-input v-model="applayform.remark" type="textarea" :rows="2" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                </table>
            ...
            <div class="friendtip">
                <p class="warmtip">请填写表格</p>
                <img src="../../../assets/images/onegirl.gif"/>
            </div>
        </el-scrollbar>
    </div>
</template>
    ...
    data(){
        ...
        return{
            ...
            useryz:{
                ...
                pname:[{required: true,message: "请输入供应商名称",trigger: "blur"}],
                ...
                paddr:[{required: true,message: "请输入供应商地址",trigger: "blur"}],
                leader:[{required: true,message: "请输入供应商负责人",trigger: "blur"}],
                personid:[{validator:Idcard,trigger: "blur"}],
                telno:[{validator: checkPhone,trigger: "blur"}],
                coid:[{required: true,message: "请输入社会信用号",trigger: "blur"}],
                bankcode:[{required: true,message: "请输入银行账号",trigger: "blur"}],
            },
            saftplanId:0,
        }
    },
