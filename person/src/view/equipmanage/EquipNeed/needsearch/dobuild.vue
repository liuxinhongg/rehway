                            ...
                            <tr>
                                ...
                                <td colspan="9">
                                    <el-form-item prop="planName">
                                        <el-input v-model.trim="saftplanform.planName" style="width:280px" placeholder="设备需求计划名称"></el-input>
                                    </el-form-item>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="mnum">
                                    <el-input v-model.trim="equipdetialform.mnum" style="width:220px;" placeholder="请输入机械物资数量"></el-input>
                                </el-form-item>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <el-form-item prop="remark">
                                    <el-input  v-model.trim="equipdetialform.remark" type="textarea" :rows="2"></el-input>
                                </el-form-item>
                            </td> 
                        </tr>
                    </table>
        ...
        return{
            ...
            modelrules:{
                mnum:[{ required: true,message: "请输入需用使用量",trigger: "blur"},
                   { pattern: /^[1-9]{1}[0-9]{0,3}$/,message:'使用量最大不能超过四位数' }                 
                ],
            ...
            useryz:{
                ...
                {pattern:/^[\u4e00-\u9fa5_a-zA-Z]{2,20}$/,message:'设备需求计划名称范围（2~20字符）'}],             
    ...
    methods:{
        ...
        modelesubmit(Fname){
            this.$refs[Fname].validate((valid) => {
                // let numnumber=/^[1-9]+/;
                // if(this.equipdetialform.mnum==''||this.equipdetialform.mnum==null){
                // }else if(!numnumber.test(this.equipdetialform.mnum)){
                // }else{
                if(this.id==0){
                    if(this.modId==0){
