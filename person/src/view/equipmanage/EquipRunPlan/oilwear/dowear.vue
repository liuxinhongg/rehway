                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="oilVal">
                                <el-input v-model.trim="projcheckform.oilVal" style="width:280px" placeholder="请输入加油量"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td>
                            <el-form-item prop="price">
                                <el-input v-model.trim="projcheckform.price" style="width:280px"  placeholder="请输入单价"></el-input>
                            </el-form-item>
                        </td>
                        <td class="tdleft">小计：</td>
                        <td>
                            <el-form-item prop="subtotal">
                                <el-input :value="projcheckform.price*projcheckform.oilVal" style="width:280px"></el-input>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="remark">
                                <el-input v-model.trim="projcheckform.remark" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
