...
<template>
    <div class="rebuild">
        ...
        <el-scrollbar style="height:100%;">    
            <el-form :model="projcheckform" :rules="byplan" @submit.native.prevent  ref="projcheckform">
                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="maintainName">
                                <el-input v-model.trim="projcheckform.maintainName" style="width:280px" placeholder="请输入保养名称"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="chkCircle">
                               <el-input v-model.trim="projcheckform.chkCircle" style="width:280px;" placeholder="请输入保养周期"></el-input>
                            </el-form-item>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="height:100px;" >
                            <el-form-item prop="chkCont">
                                <el-input type="textarea" :rows="4" v-model.trim="projcheckform.chkCont" placeholder="请输入检查内容"></el-input>
    ...
    data(){
        ...
        return{
            ...
            byplan:{
                ...
                maintainName:[
                    {required: true,message: "请输入保养名称",trigger: "blur"},
                    {pattern:/^[\u4e00-\u9fa5_a-zA-Z0-9]{2,20}$/,message:'名称格式不正确'},
                ],
                userId:[{ required: true,message: "请选择检查位置",trigger: "change"}],
                chkCircle:[{validator:freqNum,trigger: "blur"}],
                chkMan:[{required: true,message: "请选择",trigger: "change"}],
                chkCont:[{required: true,message: "请输入检查内容", trigger: 'blur'}],
                chkMan:[{required: true,message: "请选择责任人",trigger: "change"}],
