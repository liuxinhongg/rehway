                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            <el-form-item prop="planname">
                                <el-input v-model.trim="saftplanform.planname" style="width:280px" placeholder="总计划名称"></el-input>
                            </el-form-item>
                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="mnum">
                                    <el-input v-model.trim="modelform.mnum" style="width:280px" placeholder="请输入使用量"></el-input>
                                </el-form-item>
                            </td>
                            <td class="tdleft">备注：</td>
                            <td>
                                <el-form-item prop="remark">
                                    <el-input  v-model.trim="modelform.remark" type="textarea" :rows="2"></el-input>
                                </el-form-item>
                            </td> 
                        </tr>
    ...
    data(){
        return{
            ...
            useryz:{
                ...
                planname:[{required: true,message: "请输入总计划名称",trigger: "blur"},{pattern:/^[\u4e00-\u9fa5_a-zA-Z]{2,20}$/,message:'名称范围2~20个字符'}],
                        ...
                        if(this.doubledata.length!=0){
                            for(let item in this.materoption){
                                if(this.materoption[item].id==this.modelform.mmid){
                                    console.log(this.materoption[item].mname)
