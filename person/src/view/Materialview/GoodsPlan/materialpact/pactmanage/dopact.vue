    ...
    <div class="rebuild" >
        ...
        <div v-if="childsta==false"><el-scrollbar style="height:100%;">    
            <el-form :model="saftplanform" :rules="useryz" @submit.native.prevent  ref="saftplanform">
                <el-form-item style="text-align:center;"><h3>材料合同管理表</h3></el-form-item>
                <table border="1" class="tableinsert">
                    <tr>
                        <td class="tdleft" colspan="2">申请人：</td>
                        <td colspan="5">
                            <el-form-item prop="userId">
                                <el-select v-model="saftplanform.userId" style="width:280px">
                        ...
                        <td colspan="5">
                            <el-form-item prop="ctname">
                                <el-input v-model.trim="saftplanform.ctname" style="width:280px" placeholder="合同名称"></el-input>
                            </el-form-item>
                        </td>
                    ...
                    <tr>
                        ...
                        <td  colspan="5">
                            <el-form-item prop="deposit">
                                <el-input v-model.trim="saftplanform.deposit" style="width:280px" placeholder="保证金"></el-input>
                            </el-form-item>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="19">
                            <el-form-item  prop="paycond">
                                <el-input v-model.trim="saftplanform.paycond" type="textarea" :rows="2"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="19">
                            <el-form-item prop="mainct">
                                <el-input v-model.trim="saftplanform.mainct" type="textarea" :rows="2"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="ctdNum" >
                                    <el-input v-model.trim="modelform.ctdNum" style="width:280px" placeholder="请输入采购数量"></el-input>
                                </el-form-item>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="ctdMoney">
                                    <el-input v-model.trim="modelform.ctdMoney" style="width:280px" placeholder="请输入采购单价"></el-input>
                                </el-form-item>
                            </td>
                        ...
                        <tr v-if="istrue">
                            ...
                            <td colspan="3">
                                <el-form-item prop="ctdRealSum"  style="width:280px">
                                    <el-input v-model.trim="modelform.ctdRealSum" type="number"></el-input>
                                </el-form-item>
                            </td>
    ...
    data(){
        return{
            ...
            modelrules:{
                ...
                ctdNum:[{required: true,message: "请输入采购数量",trigger: "blur"},{pattern:/^[1-9]{0,1}\d{1,8}$/,message:'采购数量格式错误,不超过9位数字'}],
                // ctdMoney:[{required: true,message: "请输入采购单价",trigger: "blur"}],
                ctdMoney:[{required: true,message: "请输入采购单价",trigger: "blur"},{pattern:/^[1-9]{0,1}\d{1,16}$/,message:'采购单价格式错误,不超过17位数字'}],
            ...
            useryz:{
                ...
                ctname:[{required: true,message: "请输入合同名称",trigger: "blur"},{pattern:/^[\u4e00-\u9fa5_a-zA-Z]{2,30}$/,message:'合同名称范围5~30之间'}],
                ctsum:[{required: true,message: "请输入合同金额",trigger: "blur"},{pattern:/^[1-9]{0,1}\d{1,17}$/,message:'合同金额格式错误,不超过17位数字'}],
                ...
                deposit:[{required: true,message: "请输入保证金",trigger: "blur"},{pattern:/^[1-9]{1}[0-9]{1,6}$/,message:'保证金范围1~7位数字'}],
        ...
        doubmodify(id){
            if(this.id==0){
                ...
                this.$http.get(material.mcontractselectBy,{params:{ctmId:id}}).then(res=>{
                    ...
                    if(typeof(res.data.list[0].ctdState)=='number'){
                        this.modelform.ctdState = res.data.list[0].ctdState.toString()
                    }
                })
            }
        ...
        if(this.saftplanId!=0){
            ...
            this.$http.get(material.mcontractselect,{params:{ctid:this.id}}).then(res=>{
                ...
                if(typeof(res.data.list[0].state)=='number'){
                    this.saftplanform.state = this.saftplanform.state.toString();  
                }
