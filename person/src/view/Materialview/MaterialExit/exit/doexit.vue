                        ...
                        <el-form-item style="text-align:center;"></el-form-item>
                            <table border="1" class="tableinsert">
                                ...
                                <tr v-if='doubledata.length>0'>
                                    ...
                                    <td colspan="3" style="text-align:center;">领用仓库</td>
                               ...
                               <tr>
                                    ...
                                    <td colspan="19">
                                        <el-form-item prop="remark">
                                            <el-input v-model.trim="needplamform.remark" type="textarea" :rows="2" maxlength="300"></el-input>
                                        </el-form-item>
                                    </td>
                                </tr>
                            </table>
                ...
                <el-form :model="modelform" ref="modelform" :rules="modelrules" @submit.native.prevent>
                    <table border="1" class="tableinsert" style="width:95%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="mnum">
                                    <el-input v-model="modelform.mnum" style="width:280px" placeholder="请输入使用量"></el-input>
                                </el-form-item>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <el-form-item prop="remark">
                                    <el-input  v-model.trim="modelform.remark" type="textarea" :rows="3" maxlength="300"></el-input>
                                </el-form-item>
                            </td> 
                        </tr>
                    </table>
        ...
        return{
            ...
            modelrules:{
                mnum:[{ required: true,message: "请输入需用使用量",trigger: "blur"},
                    {pattern:/^[1-9]{1}[0-9]{0,3}$/,message:'使用量不能超过三位数'}],
                mloc:[{required: true,message: "请选择使用位置",trigger: "blur"}],
                mmid:[{required: true,message: "请选择材料",trigger: "blur"}],
                mid:[{required: true,message: "请选择材料",trigger: "change"}],
                useloc:[{required: true,message: "请选择仓库位置",trigger: "change"}],
                repoid:[{required: true,message: "请选择领用仓库",trigger: "change"}],
            },
            ...
            useryz:{
                inputid:[{required: true,message: "请选择录入人员",trigger: "change"}],           
                prjid:[{required: true,message: "请选择项目",trigger: "change"}],           
                teamid:[{required: true,message: "请选择录入班组",trigger: "change"}],              
                iptDate:[{required: true,message: "请选择录入日期",trigger: "change"}],
                state:[{required: true,message: "请选择出退库",trigger: "change"}]
            },
            personoption:[],
            categoryoption:[],
            stateoption:[
