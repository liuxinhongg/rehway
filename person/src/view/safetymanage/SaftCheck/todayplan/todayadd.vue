                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="riskScore">
                                <el-input v-model.trim="saftplanform.riskScore" required style="width:280px" placeholder="请输入扣除分数"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="chkCont">
                                <el-input placeholder="隐患内容不能超过300字" v-model.trim="saftplanform.chkCont" type="textarea" :row="3" style="width:100%" maxlength="300"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
    ...
    data(){
        return{
            ...
            useryz:{
                ...
                riskScore:[
                    {required: true,message: "请输入扣除分数",trigger: "blur"},
                    {pattern:/^[0-9]{1}[0-2]{0,1}$/,message: "扣除分数最大是12分",},
                ],
                    ...
                    if(this.id==0){
                        ...
                        this.$http.post(security.risktodayinsert,this.ajform).then(res=>{
                            ...
                            if(res.data.result=='success'){
                                ...
                                this.$router.push('/saftmanage/safttoday');
