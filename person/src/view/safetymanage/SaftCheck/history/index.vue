<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="adverData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
      ...
      <el-table-column label="隐患检查人" sortable prop="chkManName"></el-table-column>
      <el-table-column label="检查类型" prop="chkTypeName"></el-table-column>
      <el-table-column label="检查区域" prop="chkLocName"></el-table-column>
      <el-table-column label="隐患级别" prop="riskAttrName"></el-table-column>
      <el-table-column label="扣除分数" prop="riskScore"></el-table-column>
      <el-table-column label="隐患负责人" prop="riskLeaderName"></el-table-column>
      <el-table-column label="隐患类型" prop="riskTypeName"></el-table-column>
      <el-table-column label="隐患状态" prop="riskStateName"></el-table-column>
      ...
      <el-table-column label="隐患内容" width="200">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button type="text" @click="modify(scope.row.id)">详情</el-button>
        </template>
      </el-table-column> -->
    </el-table>
    <div class="block">
...
export default {
  ...
  methods: {
    dataAll(){
      ...
      this.$http.get(security.riskhistoryselectby,{params:data}).then(res=>{
        console.log(res);
    ...
    // 列表的修改
    modify(id){
      this.$router.push({path:'/saftmanage/saftaddhistory?id='+id});
    },
     uploadperson(){
