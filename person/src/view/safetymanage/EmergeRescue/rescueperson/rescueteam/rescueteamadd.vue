                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="remark">
                                <el-input v-model.trim="resuetaform.remark" type="textarea" :rows="4" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
...
export default {
    data(){
        return{
            ...
            useryz:{
                ...
                duty:[{required: true,message: "请输入职务",trigger: "blur"},{ pattern: /^[\u4e00-\u9fa5_a-zA-Z]{2,15}$/,message: '职务不能超过15个字符'}],
            },
            eduId:0,
        }
    ...
    mounted(){
        ...
        if(this.eduId!=0){
          this.$http.get('/api/security/selectOne',{params:{id:this.eduId}}).then(res=>{
              console.log(res);
              this.resuetaform=res.data.RiskSec;
          })
