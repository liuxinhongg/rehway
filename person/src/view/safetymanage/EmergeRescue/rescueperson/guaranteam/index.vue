...
<template>
    <div class="rescteam">
        <p class="toptext">后勤保障组列表</p>
        <el-form :model="rescteamform" :inline="true" @submit.native.prevent>
            <el-form-item>
               <span>救援人员：</span> <el-input v-model.trim="rescteamform.workerName" style="width:220px;"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
    ...
    methods:{
        ...
        addrescteam(){
            this.$router.push({path:'/saftmanage/guaranteamadd?id=0'});
        },
        exporttegral(){},
        // 查看
        checkhandle(id){
            this.$router.push({path:'/saftmanage/guaranteamadd?id='+id});
        },
        // 删除
        deletehandle(id){
            this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                ...
                type: 'warning'
                    ...
                    this.$http.get(security.securitydelete,{params:{id:id}}).then(res=>{
                        console.log(res);
