                    ...
                    <tr>
                        ...
                        <td>
                           <el-form-item prop="loc">
                                <el-input v-model.trim="projcheckform.loc" style="width:280px" placeholder="请输入详细检查部位"></el-input>                                                                
                            </el-form-item>
                        </td>
    ...
    data(){
        return{
            ...
            useryz:{
                ...
                subItem:[{required: true,message: '请选择分部分项',trigger: "change"}],
                locid:[{required: true,message: '请选择检查部位',trigger: "change"}],
                mdate:[{required: true,message: '请选择测量日期',trigger: "change"}],
                resman:[{required: true,message: '请选择项目负责人',trigger: "change"}],
                mman1:[{required: true,message: '请选择验收人员1',trigger: "change"}],
                mman2:[{required: true,message: '请选择验收人员2',trigger: "change"}],
                mman3:[{required: true,message: '请选择验收人员3',trigger: "change"}],
                loc:[{required: true,message: "请输入详细检查部位",trigger: "blur"}],
                result:[{required: true,message: '请选择测量结果',trigger: "change"}],
            },
        }
    },
    methods:{
