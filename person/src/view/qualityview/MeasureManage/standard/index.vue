<template>
  <div>
    <p class="toptext">项目标准数据列表</p>
    <el-form :model="sousou" class="searchfrom" :inline="true" @submit.native.prevent>
           <el-form-item prop="auditMan">
             <span>检查项：</span>
              <el-input v-model.trim="sousou.chkItem" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item prop="id" >
              <span>编号：</span>
              <el-input v-model.trim="sousou.id" style="width:200px;"></el-input>
            </el-form-item>
      <el-form-item>
     ...
     <el-table ref="multipleTable" :data="hiddenpageData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
        ...
        <el-table-column label="测量工具" prop="mtool" ></el-table-column>
         <el-table-column label="测试取点个数" prop="mnum"  sortable></el-table-column>        
