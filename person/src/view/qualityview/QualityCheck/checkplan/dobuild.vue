                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="chkArea">
                                <el-input v-model.trim="projcheckform.chkArea" style="width:280px" placeholder="请输入检查部位" ></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="freq">
                                <el-input v-model="projcheckform.freq" type="number" style="width:280px" :maxlength="2" placeholder="请输入检查频率"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <el-form-item prop="descri">
                                <el-input v-model.trim="projcheckform.descri" type="textarea" :rows="4" :maxlength="200"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
        ...
        return{
            ...
            useryz:{
                ...
                chkArea:[{required: true,message: "请输入标题",trigger: "blur"},
                        { pattern: /^[A-Za-z0-9\u4e00-\u9fa5]{3,30}$/,message:'请输入正确的格式，长度不超过30' } 
                ],
    ...
    methods:{
        prsubForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    if(this.projcheckform.chkArea.length>10){
                        this.$message.error('请不要超过多上个')
                    }
