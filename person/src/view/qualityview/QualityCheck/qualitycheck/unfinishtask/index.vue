...
<template>
  <div class="unfinishcheck">
    <el-form :model="finishform" class="searchfrom" :inline="true" @submit.native.prevent>
      <el-form-item>
        <span>任务编码：</span>
          <el-input v-model="finishform.id" style="width:230px;" placeholder="任务编码"></el-input>
      </el-form-item>
      <el-form-item prop="riskState" style="margin-left:20px;">
        <span>检查时间：</span>
        <el-date-picker v-model="finishform.chkDate" type="datetime" style="width:230px;" placeholder="选择检查时间" format="yyyy-MM-dd hh:mm:ss" value-format="timestamp">
    </el-date-picker>
      </el-form-item>
      <el-form-item>
