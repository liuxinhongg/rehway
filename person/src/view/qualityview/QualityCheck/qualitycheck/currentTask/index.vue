<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="currentData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
      ...
      <el-table-column label="检查人" prop="chkManName" width="100" sortable></el-table-column>
      ...
      <el-table-column label="负责人" prop="dirManName" width="120" sortable></el-table-column>
