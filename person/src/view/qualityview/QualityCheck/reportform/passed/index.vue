<template>
  <div>
    <p class="toptext">质量检查通过列表</p>
    <el-form :model="sousou" class="searchfrom" :inline="true" @submit.native.prevent>
      <el-form-item prop="loc">
         <span>整改位置：</span> <el-input v-model="sousou.loc" style="width:280px;" placeholder="请输入整改位置"></el-input>
      </el-form-item>
      <el-form-item prop="chkMan">
          <span>实际检查人：</span>    
          <el-select v-model="sousou.chkMan" placeholder="请选择实际检查人">
   ...
   <el-table ref="multipleTable" :data="hiddenpageData" tooltip-effect="dark" border style="width: 90%;margin:auto;">
        ...
        <el-table-column label="整改审核人" prop="dirManName" width="120" sortable></el-table-column>
