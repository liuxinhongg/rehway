 ...
 <template>
    <div class="partconfig">
        ...
        <el-form :inline="true" :model="toppartform" class="demo-form-inline"  @submit.native.prevent>
            <el-form-item>
               <span>部门名称：</span> <el-input v-model.trim="toppartform.departmentName" placeholder="部门名称" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item>
                <span>负责人：</span>
                <el-select v-model="toppartform.leaderMan" style="width:200px;">
        ...
        <div class="alltable">
            <el-scrollbar style="height:100%;">
                <el-table :data="partData" border  style="width: 100%">
                    ...
                    <el-table-column prop="subPrjIdName" label="分包项目"> </el-table-column>
                    <el-table-column prop="departmentName" label="部门名称"> </el-table-column>
                    <el-table-column prop="leaderManName" label="负责人" sortable> </el-table-column>
        ...
        <el-dialog :title="message" :visible.sync="partVisible" width="50%" center>
            <el-form :model="doform" ref="doform" :rules="partrules" @submit.native.prevent style="width:85%;margin:auto;">
                <table border="1" class="tableinsert">
                    <tr>
                        <td class="tdleft" >部门名称：</td>
                        <td>
                            <el-form-item prop="departmentName" style="text-align:center;">
                                <el-input v-model.trim="doform.departmentName" autocomplete="off" style="width:220px;" placeholder="请输入部门名称"></el-input>
                            </el-form-item>
                        </td>
                        <td class="tdleft" >负责人：</td>
                        <td>
                            <el-form-item prop="departmentName" style="text-align:center;">
                                <el-select v-model="doform.leaderMan" style="width:220px;">
                                    <el-option v-for="(item,index) in personoption" :key="index" :value="item.workerId" :label="item.workerName"></el-option>
                                </el-select>
                            </el-form-item>
                        </td>
                    ...
                    <tr>
                        <td class="tdleft" >分包项目：</td>
                        <td>
                            <el-form-item prop="departmentName" style="text-align:center;">
                                <el-select v-model="doform.subPrjId" style="width:220px;">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                           <el-form-item >
                                <el-input v-model.trim="doform.comment" type="textarea" :rows="3" style="width: 100%;"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                </table>
    ...
    data(){
        return{
            ...
            partrules:{
                ...
                subPrjId:[{ required: true, message: '请选择分包项目', trigger: 'change' }],
...
.partconfig .el-form-item__error{
    left: 155px;
}
</style>