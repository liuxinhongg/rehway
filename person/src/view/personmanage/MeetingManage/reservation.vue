<template>
  <div class="wrapper">
    <p class="persontop" style="width:100%;">会议预定</p>
    ...
    <el-dialog title="会议预定" :visible.sync="ydVisible" center width="45%">
      <el-form :model="formLabelAlign" ref="formLabelAlign" rules="meetingrules" class="demo-formLabelAlign">
        <table border="1" class="tableinsert" style="width:95%;">
          <tr>
              <td class="tdleft">会议主题：</td>
              <td> 
                <el-form-item class="item-inline" prop="theme">
                  <el-input v-model="formLabelAlign.theme" autofocus></el-input>
                </el-form-item>
              </td>
              <td class="tdleft">会议室：</td>
              <td>
                <el-form-item class="item-inline" prop="site">
          ...
          <tr>
            ...
            <td class="tdleft">设备：</td>
              <td>
                <el-form-item class="item-inline" prop="checkList">
