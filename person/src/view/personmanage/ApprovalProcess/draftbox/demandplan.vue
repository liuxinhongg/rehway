                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            <el-form-item prop="mrName">
                                <el-input v-model="saftplanform.mrName" style="width:280px" placeholder="总计划名称"></el-input>
                            </el-form-item>
                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <el-form-item prop="msum">
                                    <el-input :value="modelform.mnum*modelform.mprice" type="number"></el-input>
                                </el-form-item>
                            </td>
        ...
        return{
            ...
            modelrules:{
                mnum:[ 
                    ...
                    { pattern: /^[1-9]\d*$/,message:'请输入正确的使用量' } 
                    ],
                mprice:[ 
            ...
            useryz:{
                ...
                mrName:[{required: true,message: "请输入需求计划名称",trigger: "blur"}],
            },
            saftplanId:0,
            modleId:0,
            childValue:[],
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    this.ajform.append('mRequirePlanDetails',a);
                        // 编辑的方法
                        this.ajform.append('mrid',this.id)
