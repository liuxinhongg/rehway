  ...
  <div>
    <div class="undodetail">
      <el-scrollbar style="height:100%;">
        ...
        <div class="flowImgForm">
            <div class="topImg">
                <img :src="'data:image/jpeg;base64,'+flowImage.picture" alt="" >
            </div>
            <!-- <el-form > -->
            <!-- 请假 -->
            <table border="1" class="tableinsert" v-if="isLeaveRequest==true" style="width:50%;">
                <tr>
...
export default {
  ...
  methods: {
    ...
    getformdata(){
         let data = {
          ...
          this.$http.get(personapi.inqueryde,{params:data}).then(res=>{
              console.log(res);
            if(res.data.result == 'success'){
  ...
  mounted(){
    ...
    //     id:this.id
    // }
    this.$http.post('/api/flow/flowImage?id='+this.id).then(res=>{
        console.log(res);
        this.flowImage=res.data;
    })
