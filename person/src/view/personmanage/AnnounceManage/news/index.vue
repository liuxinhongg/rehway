...
<template>
  <div>
    <p class="toptext">新闻列表</p>
    <el-form :inline="true" :model="newsform" class="searchnewstop" @submit.native.prevent>
      ...
      <el-form-item style="float:right;">
          <el-button style="margin:-13px 0px" type="success" @click='addnew()'>+新增</el-button>
    ...
    <el-table :data="adverData" border style="width: 90%;margin:0 auto;">
      ...
      <el-table-column prop="issuer" label="发布者" width="200" sortable></el-table-column>
      <el-table-column prop="author" label="发布时间" width="250">
