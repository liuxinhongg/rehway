  ...
  <div>
    ...
    <el-table :data="adverData" border style="width: 90%;margin:0 auto;">
      ...
      <el-table-column label="制度文件">
        <template slot-scope="scope">
          <a :href="downurl+scope.row.detailsUrlLocation">{{scope.row.detailsUrlName }}</a>
        </template>
      </el-table-column>
    </el-table>
    <div class="block">
            ...
            <tr>
                ...
                <td>
                  <el-form-item prop="title" >
                    <el-input v-model.trim="adform.title" placeholder="制度标题"></el-input>
                  </el-form-item> 
                </td>
            ...
            <tr>
              ...
              <td colspan="3">
                <el-form-item prop="remark" >
                  <el-input v-model.trim="adform.remark" type="textarea" :rows="4" :maxlength="100"></el-input>
                </el-form-item>
              </td>
            </tr>
        </table>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
          // systemcode:[{required: true,message: "请输入制度编号"},{pattern:/^[0-9][a-zA-Z]{5,20}$/,message:'请输入正确的制度编号（5~20位）'}],
          author: [
          ...
          title: [
              ...
              {pattern:/^[\u4e00-\u9fa5_a-zA-Z]{2,30}$/,message:'标题不能超过30位'}
          ],
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
            ...
            form.append('filepaths',this.adform.file);
            // form.append('systemcode',this.adform.systemcode);
            form.append('titleName',this.adform.title);
            form.append('time',this.adform.sendtime);
