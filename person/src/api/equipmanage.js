...
export const devreqplansubmit=`/api/devreqplan/submit`  //提交
export const devreqplansave=`/api/devreqplan/save`  //保存
...
export const devmantplansubmit=`/api/devmantplan/submit` //提交
export const devmantplansave=`/api/devmantplan/save` //保存
...
export const devbusinessplansubmit=`/api/dev/businessplan/submit` //提交
export const devbusinessplansave=`/api/dev/businessplan/save` //保存
...
export const devbusinessplandetaildelete=`/api/dev/businessplan/detail/delete` //删除
