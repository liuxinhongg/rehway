                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="freq">
                                <el-input v-model="projcheckform.freq" type="number" style="width:280px" :maxlength="2"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
...
export default {
                    ...
                    if(this.eduId==0){
                        this.$http.post(qualitymanage.checkplaninsert,checkform).then(res=>{
                            if(res.data.result=='success'){
                                ...
                                this.$router.push('/equipmanage/upkeephistory');
    ...
    mounted(){
        ...
        if(this.eduId!=0){
            this.$http.get(equipmanage.devchkhistoryselectBy,{params:{chkid:this.eduId}}).then(res=>{
                console.log(res);
