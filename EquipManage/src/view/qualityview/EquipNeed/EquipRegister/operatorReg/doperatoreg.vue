                    ...
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="operName">
                                <el-input v-model="projcheckform.operName" style="width:280px"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <el-form-item prop="operIdCard">
                                <el-input v-model="projcheckform.operIdCard" style="width:280px"></el-input>                                
                            </el-form-item>
                        </td>
                        <td class="tdleft">性别：</td>
                        <td>
                            <el-form-item prop="gender">
                                <el-select v-model="projcheckform.gender" style="width:280px">
...
export default {
    data(){
        ...
        return{
            ...
            chkLocoption:[],
            useryz:{
                operName:[{required: true,message: "请输入操作员姓名",trigger: "blur"}],
                operIdCard:[{required: true,message: "请输入操作员身份证号",trigger: "blur"}],
                devcode:[{required: true,message: "请输入设备编码",trigger: "change"}],
