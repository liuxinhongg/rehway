...
// 物资类别
export const MTypes=`dict/selectMaterialsTypes`;
// 配置字典表
...
// 合同类型字典表
export const selectContractTypesAll=`/api/dict/selectContractTypesAll`//查询
// 班组
export const teamconfig=`/api/team/team_select_list` 
// 通讯录
export const linkperson=`/api/dep/getDepAddBook`