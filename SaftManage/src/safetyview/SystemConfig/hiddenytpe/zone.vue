    ...
    methods:{
        ...
        submitForm(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$http.post(sublocalform.locationinsert,sublocalform,{ headers: { 'Content-Type': 'application/x-www-form-urlencoded' }}).then(res=>{
                        console.log(res);
        ...
        deletehandle(id){
            this.$confirm('此操作将永久删除该条数据, 是否继续?', '提示', {
                ...
                this.$http.post(security.locationdelete,{params:{id:id}}).then(res=>{
                    if(res.data.result='success'){
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
        ...
        localdata(){
            ...
            this.$http.get(security.locationselectBytitle,{params:data}).then(res=>{
